...
const About = () => {
  return (
    <Layout>
      {/* The -mt-20 or -mt-24 here pulls the Hero section up into the Layout's empty space.
        Adjust the number (20, 24, 32) until it looks perfect.
      */}
      <section className="-mt-20 pt-24 pb-12 bg-gradient-to-b from-secondary/50 to-background border-none">
      ...
      {/* The Economic Challenge - pt-0 ensures no extra gap here */}
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 font-body text-lg text-muted-foreground leading-relaxed">
              ...
              <p className="text-foreground font-medium border-l-4 border-primary pl-6 py-2 bg-secondary/30">
            ...
            <div className="bg-secondary p-8 rounded-2xl border border-primary/10 shadow-sm">
      ...
      {/* ... the rest of the file (Strategy, Inspiration, CTA) continues as before ... */}
